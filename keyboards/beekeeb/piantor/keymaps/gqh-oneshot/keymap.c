...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_DEF] = LAYOUT_split_3x6_3(
        ...
        OSM(MOD_LGUI),  KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,                               KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_SLSH,  OSM(MOD_LCTL),
                                            OSM(MOD_LALT),  TO(_NAV),  OSL(_SYM),        OSM(MOD_LSFT),  KC_SPC,  KC_ENT
    ),
    [_NAV] = LAYOUT_split_3x6_3(
        XXXXXXX,        G(KC_Z),  G(KC_X),  G(KC_C),   G(KC_V),  SCMD(KC_Z),                    A(KC_LEFT),  KC_PGDN,  KC_PGUP,  A(KC_RGHT),  KC_DEL,      KC_BSPC,
        KC_ESC,         TAB_BWD,  TAB_FWD,  APP_BWD,   APP_FWD,  G(KC_LBRC),                    KC_LEFT,     KC_DOWN,  KC_UP,    KC_RGHT,     G(KC_RBRC),  XXXXXXX,
        OSM(MOD_LGUI),  WIN_BWD,  WIN_FWD,  S(KC_TAB), KC_TAB,   G(KC_RBRC),                    G(KC_LEFT),  KC_HOME,  KC_END,   G(KC_RGHT),  XXXXXXX,     OSM(MOD_LCTL),
                                            OSM(MOD_LALT),  RESET,  OSL(_SYM),            OSM(MOD_LSFT),  KC_SPC,  KC_ENT
    ),
    [_SYM] = LAYOUT_split_3x6_3(
        KC_TAB,         S(KC_3),  KC_7,  KC_8,  KC_9,  S(KC_4),                               S(KC_7),    S(KC_8),  KC_LBRC,     KC_RBRC,     S(KC_BSLS),  KC_BSPC,
        KC_ESC,         S(KC_2),  KC_4,  KC_5,  KC_6,  S(KC_5),                               S(KC_1),    KC_MINS,  S(KC_9),     S(KC_0),     S(KC_MINS),  KC_GRV,
        OSM(MOD_LGUI),  S(KC_6),  KC_1,  KC_2,  KC_3,  S(KC_BSLS),                            S(KC_GRV),  KC_EQL,   S(KC_LBRC),  S(KC_RBRC),  S(KC_EQL),   XXXXXXX,
                                            KC_DOT, KC_0, OSL(_SYM),                      KC_0,  KC_SPC,  KC_ENT
    )
    // [_EXT] = LAYOUT_split_3x6_3(
    //     KC_GRV,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,                               KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,     KC_BSPC,
    //     KC_ESC,         KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                               KC_H,    KC_J,    KC_K,    KC_L,    KC_QUOT,  KC_ENT,
    //     OSM(MOD_LGUI),         KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                               KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_MINS,  KC_SLSH,
    //                                         OSM(MOD_LALT), OSL(_SYM),  TO(_NAV),        OSM(MOD_LSFT),  KC_SPC,  OSM(MOD_LCTL)
    // ),
};
