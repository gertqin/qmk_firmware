...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_COLEMAK] = LAYOUT_split_3x6_3(
        ...
        KC_GRV,  LCTL_T(KC_Z),  LALT_T(KC_X),  LGUI_T(KC_C),  KC_D,  KC_V,                KC_K,  KC_M,  RGUI_T(KC_COMM), LALT_T(KC_DOT),  RCTL_T(KC_SLSH),  KC_BSLS,
    ...
    [_COLEMAK_DK] = LAYOUT_split_3x6_3(
        ...
        KC_GRV,  LCTL_T(KC_Z),  LALT_T(KC_X),  LGUI_T(KC_C),  KC_D,  KC_V,                KC_K,  KC_M,  RGUI_T(KC_COMM), LALT_T(KC_DOT),  RCTL_T(KC_SLSH),  KC_QUOT,
                            OSM(MOD_LSFT),  KC_BSPC,  LT(_SYM_RIGHT, KC_TAB),      LT(_SYM_LEFT, KC_ENT),  KC_SPC,  OSM(MOD_RSFT)
    ),
    [_SYM_LEFT] = LAYOUT_split_3x6_3(
        KC_TRNS,  S(KC_1),       S(KC_2),       S(KC_3),  S(KC_4),   S(KC_5),              KC_F6,     KC_F7,    KC_F8,    KC_F9,           KC_F10,          KC_MINS,
        KC_TRNS,  KC_1,          KC_2,          KC_3,     KC_4,      KC_5,                 XXXXXXX,   KC_RSFT,  KC_LGUI,  KC_LALT,         KC_RCTL,         KC_QUOT,
        KC_TRNS,  LCTL_T(KC_6),  LALT_T(KC_7),  KC_8,     KC_9,      KC_0,                 XXXXXXX,   KC_F11,   KC_F12,   DF(KC_COLEMAK),  DF(KC_COLE_DK),  KC_BSLS,
    ...
    [_SYM_RIGHT] = LAYOUT_split_3x6_3(
        ...
        KC_TRNS,  KC_LCTL,  KC_LALT,  KC_LGUI,  KC_LSFT,  XXXXXXX,                        KC_LEFT,     KC_DOWN,     KC_UP,       KC_RGHT,  KC_PGUP,  KC_QUOT,
        KC_TRNS,  G(KC_Z),  G(KC_X),  G(KC_C),  G(KC_V),  SGUI(KC_Z),                     KC_LBRC,     S(KC_LBRC),  S(KC_RBRC),  KC_RBRC,  KC_PGDN,  KC_BSLS,
                                           OSM(MOD_LSFT),  A(KC_BSPC),  KC_TAB,      KC_ENT,  KC_SPC,  OSM(MOD_RSFT)
    )
};
