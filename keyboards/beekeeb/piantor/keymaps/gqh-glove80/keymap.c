...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_COLEMAK] = LAYOUT_split_3x6_3(
        ...
        LGUI_T(KC_GRV),  LCTL_T(KC_Z),  LALT_T(KC_X),  KC_C,  KC_D,  KC_V,                KC_K,  KC_M,  KC_COMM, LALT_T(KC_DOT),  RCTL_T(KC_SLSH),  RGUI_T(KC_BSLS),
                                          OSM(MOD_LSFT),  KC_BSPC,  LT(_SYM, KC_TAB),      LT(_SYM, KC_ENT),  KC_SPC,  OSM(MOD_RSFT)
    ),
    [_COLEMAK_DK] = LAYOUT_split_3x6_3(
        ...
        LGUI_T(KC_GRV),  LCTL_T(KC_Z),  LALT_T(KC_X),  KC_C,  KC_D,  KC_V,                KC_K,  KC_M,  KC_COMM, LALT_T(KC_DOT),  RCTL_T(KC_SLSH),  RGUI_T(KC_QUOT),
                                          OSM(MOD_LSFT),  KC_BSPC,  LT(_SYM, KC_TAB),      LT(_SYM, KC_ENT),  KC_SPC,  OSM(MOD_RSFT)
    ),
    [_SYM] = LAYOUT_split_3x6_3(
        KC_TRNS,  S(KC_1),       S(KC_2),       S(KC_3),  S(KC_4),   S(KC_5),              S(KC_6),     S(KC_7),     S(KC_8),     S(KC_9),  S(KC_0),         KC_MINS,
        KC_TRNS,  KC_0,          KC_1,          KC_2,     KC_3,      KC_4,                 KC_LEFT,     KC_DOWN,     KC_UP,       KC_RGHT,  DF(KC_COLEMAK),  KC_QUOT,
        KC_TRNS,  LCTL_T(KC_5),  LALT_T(KC_6),  KC_7,     KC_8,      KC_9,                 KC_LBRC,     S(KC_LBRC),  S(KC_RBRC),  KC_RBRC,  DF(KC_COLE_DK),  RGUI_T(KC_BSLS),
                                               OSM(MOD_LSFT),  A(KC_BSPC),  LT(_SYM, KC_TAB),      LT(_SYM, KC_ENT),  KC_SPC,  OSM(MOD_RSFT)
    )
};
