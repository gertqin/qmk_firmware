...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_MAIN] = LAYOUT_split_3x6_3(
        ...
        OSM_LCTL,  KC_Z,   KC_X,   KC_J,   KC_D,     KC_K,                                   KC_G,     KC_P,   KC_DOT,   KC_COMM,  KC_SLSH,  FN_BSLS,
                                              GUI_ESC,  KC_R,  QK_REP,            SYM_ENT,  KC_SPC,  OSM_LALT
    ),
    [_SYM] = LAYOUT_split_3x6_3(
        KC_MINS,   KC_LT,    KC_6,   KC_5,   KC_4,   KC_GT,                                   KC_DQUO,  KC_LBRC,   KC_LPRN,  KC_RPRN,  KC_SCLN,   KC_TRNS,
        ...
        KC_TRNS,   KC_PIPE,  KC_9,   KC_8,   KC_7,   KC_PLUS,                                 KC_GRV,   KC_TAB,    KC_DOT,   KC_COMM,  KC_SLSH,   KC_BSLS,
                                              OSM_LGUI,  OSM_LALT, QK_REP,        KC_ENT,  KC_SPC,  OSM_LALT
    ),
...
const key_override_t slash_key_override = ko_make_basic(MOD_MASK_SHIFT, KC_SLSH, KC_PIPE);
const key_override_t minus_key_override = ko_make_basic(MOD_MASK_SHIFT, KC_MINS, KC_EQL);
